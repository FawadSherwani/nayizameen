...
export default function AdminPropertiesPage() {
  const [properties, setProperties] = useState(() => {
    ...
    try { return JSON.parse(window.localStorage.getItem("nayizameen-admin-properties")) || starterProperties; } catch { return starterProperties; }
  });
  ...
  useEffect(() => { window.localStorage.setItem("nayizameen-admin-properties", JSON.stringify(properties)); }, [properties]);
